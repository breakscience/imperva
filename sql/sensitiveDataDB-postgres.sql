-- Create SensitiveDataDB for postgres
...
CREATE TABLE IF NOT EXISTS Transactions (
    ...
    UserID INT NOT NULL,
    TransactionType VARCHAR(10) CHECK (TransactionType IN ('debit', 'credit')) NOT NULL,
...
(28, '9012387654', 'Peoples United Bank', 33000.00),
